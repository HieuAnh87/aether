...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::agents::deconfigure_opencode,
            commands::agents::refresh_opencode_models,
            commands::agent_providers::get_agent_providers,
            commands::agent_providers::get_provider_mode_matrix,
            ...
            commands::provider_switch::get_providers,
            commands::provider_switch::get_current_provider,
            commands::provider_switch::add_provider,
            commands::provider_switch::update_provider,
            commands::provider_switch::delete_provider,
            commands::provider_switch::remove_provider_from_live_config,
            commands::provider_switch::switch_provider,
            commands::provider_switch::import_default_config,
            commands::provider_switch::import_providers_from_live,
            commands::provider_switch::update_providers_sort_order,
            commands::provider_switch::update_tray_menu,
            commands::provider_switch::tray_select_provider,
        ])
        .setup(|app| {
